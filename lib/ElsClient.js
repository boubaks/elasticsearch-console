...
exports.ElsClient.prototype.deleteByQuery = function(index, type, query, callback) {
    ...
    console.log('tmpSearch', JSON.stringify(query));
    this._client.deleteByQuery(tmpSearch, function (error, response) {
        callback(error, response);
    });
};

exports.ElsClient.prototype.info = function(callback) {
    this._client.info(function(error, response) {
	callback(error, response);
    });
};

exports.ElsClient.prototype.segments = function(callback) {
    this._client.indices.segments(function(error, response) {
	callback(error, response);
    });
};
